...
//   //       console.log('Admin ID for removal:', adminId);
...
//       try {
//         setLoading(true);
//         console.log('Attempting to remove rights for Admin ID:', adminId); // Log the admin ID
//         await axios.put(`http://localhost:5000/admin/${adminId}/remove-rights`);
...
//               <span>{admin.name} {admin.surname}</span>
//               <Button 
//                 onClick={() => handleRemoveRights(admin.firebaseUid)}
